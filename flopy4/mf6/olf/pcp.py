...
class Pcp(Package):
    ...
    print_flows: bool = field(
        block="options", default=False, longname="print precipitation rates to listing file"
    )
    save_flows: bool = field(
        block="options", default=False, longname="save precipitation to budget file"
    )
    ...
    precipitation: Optional[NDArray[np.float64]] = array(
        block="period",
        dims=("nper", "nodes"),
        default=None,
