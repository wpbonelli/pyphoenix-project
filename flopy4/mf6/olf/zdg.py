...
class Zdg(Package):
    ...
    save_flows: bool = field(block="options", default=False, longname="save flows to budget file")
    ...
    width: Optional[NDArray[np.float64]] = array(
        block="period",
        dims=("nper", "nodes"),
        default=None,
        converter=Converter(structure_array, takes_self=True, takes_field=True),
    ...
    slope: Optional[NDArray[np.float64]] = array(
        block="period",
        dims=("nper", "nodes"),
        default=None,
        converter=Converter(structure_array, takes_self=True, takes_field=True),
    ...
    rough: Optional[NDArray[np.float64]] = array(
        block="period",
        dims=("nper", "nodes"),
        default=None,
        converter=Converter(structure_array, takes_self=True, takes_field=True),
