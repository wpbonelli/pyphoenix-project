...
class Spc(Package):
    ...
    maxbound: Optional[int] = field(
        block="dimensions", default=None, init=False, longname="maximum number of ssm entries"
    )
    bndno: Optional[NDArray[np.int64]] = array(
        block="period",
        dims=("nper",),
        default=None,
    ...
    spcsetting: Optional[Spcsetting] = field(block="period", default=None)
