...
class Uze(Package):
    ...
    save_flows: bool = field(
        block="options", default=False, longname="save UZE cell flows to budget file"
    )
    ...
    uzfno: Optional[NDArray[np.int64]] = array(
        block="packagedata",
        dims=("npackagedata",),
        default=None,
    ...
    # TODO: uzesetting — type 'union' not yet supported
