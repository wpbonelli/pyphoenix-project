...
class Sfe(Package):
    ...
    print_temperature: bool = field(
        block="options", default=False, longname="print calculated temperature to listing file"
    )
    ...
    rno: Optional[NDArray[np.int64]] = array(
        block="packagedata",
        dims=("npackagedata",),
        default=None,
    ...
    # TODO: reachsetting — type 'union' not yet supported
