...
class Evp(Package):
    ...
    print_flows: bool = field(
        block="options", default=False, longname="print evaporation rates to listing file"
    )
    save_flows: bool = field(
        block="options", default=False, longname="save evaporation to budget file"
    )
    ...
    maxbound: Optional[int] = field(
        block="dimensions", default=None, init=False, longname="maximum number of evaporation cells"
    )
    naux: Optional[int] = dim(block="__dim__", coord=False, default=None)
    evaporation: Optional[NDArray[np.float64]] = array(
        block="period",
        dims=("nper", "nodes"),
        default=None,
