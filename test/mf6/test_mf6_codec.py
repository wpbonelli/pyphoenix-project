...
def test_dumps_tas_inner_classes():
    ...
    TimeSeriesName/Sfac's data children are trailing-tokens lists, not
    scalars -- MF6 allows multiple names/scale factors on one line.
    """
...
def test_dumps_tas_inner_classes_multi_value():
    """TimeSeriesName/Sfac accept more than one trailing token, per MF6 syntax."""
    from flopy4.mf6.utl.tas import Tas
